...
$59bd74d6cb5cf9c3$export$1e90011ded576fc9.prototype = {
  ...
  **/ _postProcessContent: function(articleContent) {
        ...
        if (!this._keepClasses) // Remove classes.
        ...
        while(node){
            if (node.parentNode && [
                ...
                if (this._isElementWithoutContent(node)) {
                    ...
                    for(var i = 0; i < node.attributes.length; i++)child.setAttribute(node.attributes[i].name, node.attributes[i].value);
  ...
  **/ _grabArticle: function(page) {
      ...
      **/ var candidates = [];
            ...
            if (topCandidate === null || topCandidate.tagName === "BODY") {
                ...
                for(var i = 1; i < topCandidates.length; i++)if (topCandidates[i].readability.contentScore / topCandidate.readability.contentScore >= 0.75) alternativeCandidateAncestors.push(this._getNodeAncestors(topCandidates[i]));
   ...
   */ _getJSONLD: function(doc) {
        ...
        this._forEachNode(scripts, function(jsonLdElement) {
            if (!metadata && jsonLdElement.getAttribute("type") === "application/ld+json") try {
                ...
                if (!parsed["@context"] || !parsed["@context"].match(/^https?\:\/\/schema\.org$/)) return;
                if (!parsed["@type"] && Array.isArray(parsed["@graph"])) parsed = parsed["@graph"].find(function(it) {
                ...
                if (typeof parsed.name === "string" && typeof parsed.headline === "string" && parsed.name !== parsed.headline) {
                    ...
                    if (headlineMatches && !nameMatches) metadata.title = parsed.headline;
  ...
  **/ _getClassWeight: function(e) {
   ...
   */ _markDataTables: function(root) {
    ...
    /* convert images and figures that have properties like data-src into images that can be loaded without JS */ _fixLazyImages: function(root) {
  ...
  **/ _cleanHeaders: function(e) {
   ...
   **/ parse: function() {
        ...
        if (!metadata.excerpt) {
            ...
            if (paragraphs.length > 0) metadata.excerpt = paragraphs[0].textContent.trim();
        }
 ...
 * This code is heavily based on Arc90's readability.js (1.7.1) script
 * available at: http://code.google.com/p/arc90labs-readability
 */ var $6836a2d1efe7c321$var$REGEXPS = {
    // NOTE: These two regular expressions are duplicated in
    // Readability.js. Please keep both copies in sync.
    unlikelyCandidates: /-ad-|ai2html|banner|breadcrumbs|combx|comment|community|cover-wrap|disqus|extra|footer|gdpr|header|legends|menu|related|remark|replies|rss|shoutbox|sidebar|skyscraper|social|sponsor|supplemental|ad-break|agegate|pagination|pager|popup|yom-remote/i,
    okMaybeItsACandidate: /and|article|body|column|content|main|shadow/i
};
function $6836a2d1efe7c321$var$isNodeVisible(node) {
    // Have to null-check node.style and node.className.indexOf to deal with SVG and MathML nodes.
    return (!node.style || node.style.display != "none") && !node.hasAttribute("hidden") && (!node.hasAttribute("aria-hidden") || node.getAttribute("aria-hidden") != "true" || node.className && node.className.indexOf && node.className.indexOf("fallback-image") !== -1);
}
function $6836a2d1efe7c321$export$a4ca2693929a0329(doc, options = {}) {
    ...
    var defaultOptions = {
        ...
        visibilityChecker: $6836a2d1efe7c321$var$isNodeVisible
    };
    ...
    return [].some.call(nodes, function(node) {
        ...
        var matchString = node.className + " " + node.id;
        if ($6836a2d1efe7c321$var$REGEXPS.unlikelyCandidates.test(matchString) && !$6836a2d1efe7c321$var$REGEXPS.okMaybeItsACandidate.test(matchString)) return false;
